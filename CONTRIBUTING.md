...
When you spot an issue, [create an issue](https://github.com/buluma/ansible-role-netiq-edirectory/issues).

Raising the issue helps me and others to find similar problems and solutions in the future.

### [2. Fork the project.](#2-fork-the-project)

On the top right side of [the repository on GitHub](https://github.com/buluma/ansible-role-netiq-edirectory), click `fork`. This copies everything to your GitHub namespace.
...
```
git clone git@github.com:YOURNAMESPACE/ansible-role-netiq-edirectory.git
```
